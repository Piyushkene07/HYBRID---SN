...
filepath = f"C:/Users/piyus/Desktop/Piyush/CODING/Ml_project/best_weights.hdf5"
...
# Validation
model.load_weights(f"C:/Users/piyus/Desktop/Piyush/CODING/Ml_project/best_weights.hdf5")
model.compile(loss='categorical_crossentropy', optimizer=adam, metrics=['accuracy'])
